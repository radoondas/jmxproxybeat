...
func TestAddModulerEmptyName(t *testing.T) {
	registry := &Register{}
	err := registry.AddModuler("", func() Moduler {
		return nil
	})
...
func TestAddModulerDuplicateName(t *testing.T) {
	registry := &Register{}
	err := registry.AddModuler(moduleName, func() Moduler {
		return nil
	})
	if err != nil {
		t.Fatal(err)
...
func TestAddMetricSeterEmptyModuleName(t *testing.T) {
	registry := &Register{}
	err := registry.AddMetricSeter("", metricSetName, func() MetricSeter {
		return nil
	})
	if assert.Error(t, err) {
		assert.Equal(t, "module name is required", err.Error())
...
func TestAddMetricSeterEmptyName(t *testing.T) {
	registry := &Register{}
	err := registry.AddMetricSeter(moduleName, "", func() MetricSeter {
		return nil
	})
	if assert.Error(t, err) {
...
func TestGetModule(t *testing.T) {
	...
	registry.Modulers[moduleName] = func() Moduler {
		return nil
	}
